...
In this step, we'll update the previous app to display different content when accessed as a Full Page App.
...
2. Ensure you have built your first app using instructions given [instructions](../first_app/README.md)
